 ...
 */
namespace Cleargo\MultiCart\Block;
 ...
 * @api
 */
class SecondCart extends \Magento\Checkout\Block\Cart\AbstractCart
{
    /**
    ...
    {
        try {
            $quote = $this->quoteRepository->get($this->helper->getCheckoutSession()->getSecondQuoteId());
            $this->_quote = $quote;
        }catch (\Exception $e){
...
//
    ...
    public function getSecondCartTotals(){
        return $this->helper->getCartTotal();
    }
